...
specifier_header_path=$(find /Users/linneagilbertson/Desktop/ComputingSystemsPracticum/lab-1-log-processing-alija-linnea-1/html_components -name $header_file)

#find local file path to the footer file that will be put on the bottom
specifier_footer_path=$(find /Users/linneagilbertson/Desktop/ComputingSystemsPracticum/lab-1-log-processing-alija-linnea-1/html_components -name $footer_file)
